        ...
        <div class="container g-padding-y-80--xs">
            <div class="row">
                <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                    ...
                    <li><a class="g-font-size-15--xs g-color--white-opacity" href="{{route('home')}}">Home</a></li>
    ...
    <div class="container g-padding-y-50--xs">
        <div class="row">
            ...
            <div class="col-xs-6 g-text-right--xs">
                <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"><a href="http://keenthemes.com/preview/Megakit/">Megakit</a> <br/> BSCS Final year Project <p>Irfan Ullah</p>
             <p>Farman Ali</p>
