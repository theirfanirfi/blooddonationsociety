        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                ...
                {{-- method="post" action="{{route('signuppost')}}" --}}
                <form id="signupform" >
                    @csrf
                    <div class="row g-margin-b-40--xs">
                        <div class="col-sm-6 g-margin-b-20--xs g-margin-b-0--md">
                            <div class="g-margin-b-20--xs">
                                <input type="text" class=" required form-control s-form-v2__input g-radius--50" placeholder="* Full Name" name="fullname" id="fullname" required>
                            </div>
                        ...
                        <div class="g-margin-b-20--xs">
                            ...
                            <input type="number" class="required pakPhone form-control s-form-v2__input g-radius--50" placeholder="* Phone" name="phone" id="phone">
                        </div>
                            <div class="g-margin-b-20--xs">
